let Autocomplete = React.createClass({
  ...
  getDefaultProps () {
    return {
      ...
      renderMenu (items, value, style) {
        return (<div children={items} className = "auto-search-custom"/>);
      },
  ...
  setMenuPositions () {
    ...
    this.setState({
      ...
      menuLeft: rect.left + marginLeft + 1,
      menuWidth: rect.width + marginLeft + marginRight - 2
    })
  },
  ...
  handleInputClick () {
    ...
    if (this.isInputFocused() && this.state.isOpen === false && this.props.value !== '')
      this.setState({ isOpen: true })
  ...
  render () {
    ...
    return (
      <div style={{...this.props.wrapperStyle}} {...this.props.wrapperProps} className={"inline width-9 padding-side-1 middle"}>
        <input
